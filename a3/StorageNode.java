...
public class StorageNode {
  ...
  public static void main(String [] args) throws Exception {
    ...
    log.info("server socket: " + ipAddress);
    byte[] payload = ipAddress.getBytes();
    String zkNode = args[3] + "/child";
    log.info("Creating child node: " + zkNode);
    curClient.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath(zkNode, payload);
  }
}
