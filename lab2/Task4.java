...
public class Task4 {
  ...
  public static class Task4Combiner2 extends Reducer<Text, MapWritable, Text, MapWritable> {
    private Text pair = new Text();

    public void reduce(Text word1, Iterable<MapWritable> stripes, Context context) throws IOException, InterruptedException {
      MapWritable map = new MapWritable();
